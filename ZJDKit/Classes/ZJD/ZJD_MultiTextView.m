...
@implementation ZJD_MultiTextView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _alignmentType = Muti_Alignment_Left_Type;
    }
    return self;
}
...
-(void)layoutSubviews
{
    ...
    //
    NSArray* stringArray_f = [_showText componentsSeparatedByString:@"|"];
    ...
    for(int i=0;i<[stringArray_f count];i++)
    {
        ...
        if( i<[_setArray count] )
        {
            NSDictionary* dic_f = [_setArray objectAtIndex:i];
